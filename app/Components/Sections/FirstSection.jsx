    ...
    return (
        <div className="min-h-screen bg-gradient-to-br bg-orange-50 mb-20">
            <div className="max-w-7xl mx-auto px-6 py-16 text-center md:w-[60vw]">
                <h1 className="text-3xl md:text-5xl font-bold text-slate-800 mb-6 ml-10 md:w-[47vw]">
            ...
            <div className="max-w-7xl mx-auto px-6 md:py-16 py-10 text-center md:text-left">
                <div className="grid md:grid-cols-2 gap-12">
                    <div>
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6 leading-tight md:w-[30vw]">
